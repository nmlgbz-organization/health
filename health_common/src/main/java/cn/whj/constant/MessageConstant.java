...
public class MessageConstant {
    ...
    public static final String CANCEL_ORDER_SUCCESS = "取消预约信息成功";
    public static final String CANCEL_ORDER_FAIL = "取消预约信息失败";

    public static final String ADDRESS_IS_EMPTY = "新增地址不能为空";
    ...
    public static final String DELETE_ADDRESS_FAIL = "删除地址成功";
    public static final String ADD_ROLE_SUCCESS = "添加角色成功";
    public static final String GET_MAP_SUCCESS = "获取地址成功";
    public static final String GET_MAP_FAIL = "删除地址失败";

    public static final String ADD_ORDER_LIST_FAIL = "新增预约列表数据失败";
    public static final String ADD_ORDER_LIST_SUCCESS = "新增预约列表数据成功";
    public static final String ADD_USER_SUCCESS = "新增用户成功";
    public static final String ADD_USER_FAIL = "新增用户失败";
    public static final String QUERY_ROLES_SUCCESS = "查询所有角色成功";
    public static final String QUERY_ROLES_FAIL = "查询所有角色失败";
    ...
    public static final String PASSWORD_SIMPLE = "：密码不能低于四位";
    ...
    public static final String GET_PERMISSION_SUCCESS = "查询权限项信息成功";
    public static final String GET_PERMISSION_FAIL = "查询权限项信息失败";
    ...
    public static final String LIST_ROLE_SUCCESS = "获取权限项集合成功";
    public static final String LIST_ROLE_FAIL = "获取权限项集合失败";
    public static final String DELETE_USER_SUCCESS = "删除用户成功";
    public static final String DELETE_USER_FAIL = "删除用户失败";
    public static final String DELETE_USER_ERROR = "不能删除自己";
    public static final String GET_ROLE_SUCCESS = "查询角色成功";
    public static final String GET_ROLE_FAIL = "查询角色失败";
    public static final String LIST_PERMISSION_IDS_SUCCESS = "获取权限项id集成功";
    public static final String LIST_PERMISSION_IDS_FAIL = "获取权限项id集失败";
    public static final String EDIT_ROLE_SUCCESS = "编辑角色成功";
    public static final String EDIT_ROLE_FAIL = "编辑角色失败";

    public static final String HAS_ROLE = "已存在该角色";
    public static final String Get_SysLog_SUCCESS="获取日志信息成功";
    public static final String Get_SysLog_Fail="获取日志信息失败";
}
